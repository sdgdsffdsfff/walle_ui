 ...
 * @category System
 * @package  basedata
 * @author   Chao Hu <chao.hu@playcrab.com>
...
class HttpClient
{
     ...
     * @return mixed
     */
    public function post($url, $method, $params = null,  $headers = null)
    {
        ...
        $this->postFields = array('jsonrpc'=> static::$jsonRpcVersion, 'method'=> $method, 'params'=>$params);
