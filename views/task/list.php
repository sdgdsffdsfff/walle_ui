                ...
                <div class="panel-body">
                    <form method="get" class="form-inline">
                        <div class="form-group">
                            ...
                            <input type="text" name="version" class="form-control" placeholder="版本号" style="margin-right: 40px;" />
                        </div>
                        <div class="form-group">
                            <label class="control-label">发布人：</label>
                            <input type="text" name="release_user" class="form-control" placeholder="发布人" style="margin-right: 40px;" />
                        </div>
                        <div class="form-group">
