...
<aside id="menu">
    <div id="navigation">
        ...
        <ul class="nav" id="side-menu">
            <li class="active">
                <a href="/index/index"><span class="nav-label">首页</span></a>
            ...
            <li>
                <a href="/clientpackage/list"><span class="nav-label">安装包下载</span></a>
            </li>
            <li>
                <a href="/module/index"><span class="nav-label">更新模块版本列表</span></a>
            </li>
        </ul>
    </div>
</aside>