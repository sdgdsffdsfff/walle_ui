	...
	<div class="col-lg-10">
        <div class="hpanel">
            ...
            <div class="col-xs-5 col-md-7">
                <div class="panel-body">
                    <form id="add_deploymentconfig_form" class="form-horizontal">
                            ...
                            <table cellpadding="1" cellspacing="1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>                                               
                                            <select name="deployment_id" id="deployment_id" class="js-source-states" style="width:300px; margin-right: 40px;">
                                            <optgroup label="">
                                            <option value="">请选择部署位置</option>
<?php
if (isset($deploymentList) && !empty($deploymentList)) {//新增配置，提供全部发行地区供选择
    foreach ($deploymentList as $reg) {
...
$(function() {
    ...
    $('#add_deploymentconfig_form').validate({
        ignore: '.ignore',
        rules: {
            deployment_id: {
                required: true,
    ...
    function submitForm() {
        $.ajax({
            ...
            data:$('#add_deploymentconfig_form').serialize(),
            dataType: "json",
...
function check(parameter_type) {
    ...
    if (parameter_type == 'string') {
     return $('#add_deploymentconfig_form').validate({
            ignore: '.ignore',
            rules: {
                deployment_id: {
                    required: true,
