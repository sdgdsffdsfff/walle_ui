	...
	<div class="row">
		<div class="hpanel">
			...
			<div class="table-responsive" style="background: #fff;border: 1px solid #e4e5e7;border-radius: 2px;padding: 20px;">
				<table id="deployment_config_table" cellpadding="1" cellspacing="1" class="table table-bordered table-striped table-hover">
					<thead>
						<tr>
							<th>部署位置</th>
							<th>参数</th>
					...
					<tbody>
						<tr>
							...
							<td>zh_CN</td>
							<td align="center">
								<a href="/deployment/config-edit" class='btn btn-info'>编辑</a>
								<button class='btn btn-danger' onclick='javascript:delete_regionconfig("<?php echo "$deployment_id, $parameter_id";?>");'>删除</button>
							</td>
						</tr>
						<tr>
							<td>China</td>
...
$(function() {
    ...
    //表数据排序
    $('#deployment_config_table').dataTable({
        //操作列不排序
