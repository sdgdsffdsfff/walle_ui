    		...
    		<div class="panel-body">
    			<form method="get" class="form-inline">
    				<div class="form-group col-lg-4">
    					...
    					<input type="text" name="old_version_id" class="form-control" placeholder="旧版本号" value="<?php echo $old_version_id;?>"/>
    				</div>
    				<div class="form-group col-lg-4">
    					<label class="control-label">新版本号：</label>
    					<input type="text" name="new_version_id" class="form-control" placeholder="新版本号" value="<?php echo $new_version_id;?>"/>
    				</div>
    				<div class="form-group col-lg-4">
